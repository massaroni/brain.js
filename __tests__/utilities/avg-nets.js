...
describe('avg-nets', () => {
  ...
  describe('NeuralNetworkGPU', () => {
    ...
    it('averages the weights of 2 NeuralNetwork and 1 NeuralNetworkGPU', () => {
      const jsonA = {
        "sizes": [ 2, 2, 1 ],
        "layers": [
          {
      ...
      assert.deepEqual(jsonExpected, jsonActual);
      assert.equal(Object.getPrototypeOf(a), Object.getPrototypeOf(actual));
      assert.notEqual(Object.getPrototypeOf(b), Object.getPrototypeOf(actual));

      const actual2 = a.avg(b, c);
      assert.deepEqual(jsonExpected, actual2.toJSON());
      assert.equal(Object.getPrototypeOf(a), Object.getPrototypeOf(actual2));
    });
